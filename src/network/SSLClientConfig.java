...
public class SSLClientConfig {
	...
	/**
	 * The client keystore containing the client private key
	 */
	private KeyStore clientKeyStore;

	/**
	 * The server keystore containing the server public key
	 */
	private KeyStore serverKeyStore;

	/**
	 * The passphrase of the client keystore
	 */
	 ...
	 * 
	 * @param passphrase the passphrase of the client keystore
	 */
	SSLClientConfig(String passphrase) {
	...
	private void setupClientKeyStore() throws GeneralSecurityException, IOException {
		...
		clientKeyStore.load(new FileInputStream("keys/client.private"), passphrase.toCharArray());
	}
